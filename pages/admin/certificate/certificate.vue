<template>
	<view class="page-my">
		<!-- 头部 -->
		<view class="header">
			<cl-topbar title="证书管理" background-color="#80a3ff" color="#FFFFFF" :border="false"
				:show-back="false">
				<!-- <u-button text="退出登陆" type="primary" icon="map" @click="$goBack(2, 'pages/admin/my/my')"></u-button> -->
				</cl-topbar>
		...
		<view class="other">
			...
			<u-button text="推出登陆" type="primary" icon="accout" @click="$goBack(2, '/pages/admin/my/my')"></u-button>
		</view>
	...
	export default {
		data() {
			return {
				otherList: [{
						title: "证书设置",
						url: "/pages/admin/certificate/set"
					},
					{
						title: "证书审核",
						url: "/pages/admin/certificate/audit"
					},
					{
						title: "证书复审",
						url: "/pages/admin/certificate/review"
					},
					{
						title: "证书变更审核",
						url: "/pages/admin/certificate/change"
					},
				],
				mytabbar: user_admin,
				value: 3,
